...
use super::rect::{Rect};
use super::{SerializeMe, CombatStats, Player, Renderable, Name, Position, Viewshed, Monster, BlocksTile, Item, ProvidesHealing, Consumable, Ranged, InflictsDamage, AreaOfEffect, Confusion};
...
pub fn spawn_room(ecs: &mut World, room: &Rect) {
...

    {
        ...
        let num_monsters = rng.roll_dice(1, MAX_MONSTERS + 3) - 4;
